export default function UploadMedia({imageFile, setImageFile, setCoverImage, coverImage}){
    return (
        <div className="m-auto flex">
            <label className="flex flex-col justify-center mx-auto items-center w-fit p-10 rounded-xl border-dashed border-[3px] border-theme-grey bg-theme-light-grey">
            ...
            <label className="ml-10 flex flex-col justify-center mx-auto items-center w-fit p-10 rounded-xl border-dashed border-[3px] border-theme-grey bg-theme-light-grey">
                {/* <span className="text-[12px]">Drag and Drop Video</span> */}
